...
GetMoviesByNameUsecase({required TmdbRepository tmdbRepository}) : _tmdbRepository = tmdbRepository;


  Future<Result<List<Movie>>> execute({required String name}) async {
    final moviesByGenreResult = await _tmdbRepository.searchMovies(query: name) ;
